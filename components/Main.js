      ...
      <div className="max-w-[1080px] w-full mx-auto h-[100%] p-4 flex justify-center flex-wrap items-center gap-24">
        <div className=" flex flex-col flex-1 gap-6 text-center md:text-start">
          ...
          <div className="flex flex-col justify-between gap-4 md:flex-row">
            <Link href='http://www.linkedin.com/in/criscalderon' target="_blank" className="rounded-sm p-3 cursor-pointer hover:scale-110 ease-in duration-300 flex flex-1 bg-red-800 text-secondaryLight justify-center">
              <FaLinkedinIn size={30} />
            </Link>
            <Link href='http://www.github.com/Cristhyan1993' target="_blank" className="rounded-sm p-3 cursor-pointer hover:scale-110 ease-in duration-300 flex flex-1 bg-secondaryDark text-secondaryLight justify-center">
              <FaGithub size={30} />
            </Link>
            <Link href='https://drive.google.com/file/d/1ZP1ebpFy-KYjIXeb-QaPN2tT4g1G50wN/view?usp=sharing' target="_blank" className="rounded-sm p-3 cursor-pointer hover:scale-110 ease-in duration-300 flex flex-1 bg-primaryDark text-secondaryLight justify-center">
